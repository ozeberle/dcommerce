...
class __TwigTemplate_e60a3a56859fa35f8f63cd302cd62cdfb5cadff0743031fb18c677cec2de594d extends \Twig\Template
{
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("{% extends \"input--button.html.twig\" %}
{#
/**
 * @file
...
{% spaceless %}
  ...
  {% endblock %}
{% endspaceless %}
", "themes/contrib/bootstrap/templates/input/input--button--split.html.twig", "/var/www/html/themes/contrib/bootstrap/templates/input/input--button--split.html.twig");
    }
}
