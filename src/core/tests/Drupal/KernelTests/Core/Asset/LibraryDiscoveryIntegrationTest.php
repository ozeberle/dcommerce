...
class LibraryDiscoveryIntegrationTest extends KernelTestBase {
  ...
  public function testLibrariesOverride() {
    ...
    $this->assertAssetInLibrary('themes/mytheme/css/my-container-inline.css', 'classy', 'base', 'css');
    $this->assertAssetInLibrary('themes/mytheme/css/my-details.css', 'classy', 'base', 'css');
  ...
  public function testLibrariesOverrideOtherAssetLibraryNames() {
    ...
    $this->assertAssetInLibrary('themes/mytheme/css/dropbutton.css', 'core', 'drupal.dropbutton', 'css');
    ...
    $this->assertAssetInLibrary('//my-server/mytheme/css/jquery_ui.css', 'core', 'jquery.ui', 'css');

    // Assert an absolute URI.
    $this->assertAssetInLibrary('http://example.com/mytheme/css/farbtastic.css', 'core', 'jquery.farbtastic', 'css');
  }
